...
# Function that creates a new content placeholder file
def new_content():
    new_content_html = ""
    new_content_html += "<h1>New Content!</h1>\n"
    new_content_html += "<p>New content...</p>\n"
    open("content/new_content_page.html","w+").write(new_content_html)
